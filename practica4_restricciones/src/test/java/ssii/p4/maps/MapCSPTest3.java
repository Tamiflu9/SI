...
public class MapCSPTest3 {
	...
	public void testImprovedBacktrackingStrategy() {
		...
		System.out.println(solution);
		System.out.println(stepCounter.getResults() + "\n");
		assertThat(stepCounter.getAssignmentChanges(), equalTo(8));
		assertThat(stepCounter.getDomainChanges(), equalTo(7));
	}
	...
	public void testBacktrackingStrategy() {
		...
		System.out.println(solution);
		System.out.println(stepCounter.getResults() + "\n");
		assertThat(stepCounter.getAssignmentChanges(), equalTo(17));
		assertThat(stepCounter.getDomainChanges(), equalTo(0));
	}
